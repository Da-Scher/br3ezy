...
(1, 'LoveNature (Archived)', 'This is an archived stream. For developement purposes, it will be home to the forgotten LoveNature stream.', 'https://lnc-love-nature.tubi.video/playlist.m3u8', 'https://jbarteluce.net/files/channels4_profile.jpg', FALSE, TRUE);
